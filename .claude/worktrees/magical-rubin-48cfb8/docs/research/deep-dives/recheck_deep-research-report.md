...
| **Lima One** | **1.3+ (verified)** | 80% (purchase) | **700** (firm floor) | STR allowed (DSCR covers vacation rentals) | IO available (case-by-case) | PPP yes (subject to state law) | Lima One product page (2026) | **Verified Primary** |
...
| **Angel Oak**  | No min (no-ratio option available) | **90% at 740+ FICO** | **640** (verified Angel Oak programs page; 680 cited by Griffin's comparison is outdated) | STR via Investor Cash Flow program | 30-year fixed, 40-year term, IO options | Allows PPP (unspecified) | Angel Oak programs page (angeloakms.com, 2026) | **Verified Primary** |
