...
summary: "We audited the core DSCR (Debt-Service Coverage Ratio) formulas and built a “golden” test suite to ensure deterministic accuracy.  The **lender-qualifying DSCR** (Track A) is universally defined as **monthly rental income ÷ monthly debt service** (PITIA), while the **investor-survival DSCR** (Track B) uses **annual net operating income ÷ annual debt service**.  For Track A, “rental income” means the *eligible rent* – typically the lower of the lease rent and the appraiser’s market rent..."
entities:
  - concept/dscr
  - concept/io
  - concept/itia
...
tags:
  ...
  - topic/tax
  - type/audit
source: DSCR_deep-research-report.md
