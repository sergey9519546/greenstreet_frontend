            ...
            return (
              <div className="gs-reveal" style={{ marginTop: 28, background: dc.dark, border: "1px solid rgba(238,239,211,0.16)", borderRadius: radius.md, padding: "clamp(22px,2.6vw,32px)" }}>
                ...
                {fnElig.canLend ? (
                  ...
                  <div style={{ background: "rgba(224,99,99,0.1)", border: "1px solid rgba(224,99,99,0.4)", borderRadius: radius.sm, padding: "14px 16px", color: "#e06363", fontSize: 14, fontWeight: 600 }}>{fnElig.note}</div>
                )}
