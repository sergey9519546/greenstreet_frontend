...
**Golden Test Vector (v11.0 — June 17, 2026):**
...
These are the primary predictive signals and must be computed with verified math (v11.0 golden values).
...
**Hard FICO Caps by Program Tier (v11.0 verified):**
...
**Reserve Tiering Matrix (v11.0 verified):**
...
### 2.8 Category H — Tax Reassessment Features (Highest-Priority Fix from v11.0)
...
**Kill Criterion Status (v11.0 elevated from line item to gate):**
...
| Deephaven | **0** (low/no DSCR) | **640** | 80% | Conditional | Not stated | Verified Deephaven guidelines (2026); "low or no DSCR" + 640 FICO floor |
