...
replaces:
  - 01_research_notes/DSCR Forumals.md
  - docs/research/deep-dives/DSCR_Formulas.md archived superseded version
---

# DSCR Formulas

This is the current formula reference. It replaces the older `DSCR Forumals.md` note, whose golden vector used the rejected `$1,999` P&I / `~$2,580` PITIA / `1.16` DSCR result.
