...
function dscrColorClass(dscr: number): string {
  ...
  if (dscr >= 0.75) return "text-risk-warning";
...
function dscrBgClass(dscr: number): string {
  ...
  if (dscr >= 0.75) return "bg-risk-warning/10 border-risk-warning/25";
  return "bg-risk-danger/10 border-risk-danger/25";
}
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                  {[deal.dualTrackDSCR.track1, deal.dualTrackDSCR.track2].map(track => (
                                    <WhiteCard key={track.label} style={{ padding: "16px" }}>
                                      ...
                                      <div className={`text-2xl font-extrabold font-mono ${track.passes ? "text-emerald" : "text-risk-danger"}`}
                                        style={{ fontVariantNumeric: "tabular-nums" }}>
