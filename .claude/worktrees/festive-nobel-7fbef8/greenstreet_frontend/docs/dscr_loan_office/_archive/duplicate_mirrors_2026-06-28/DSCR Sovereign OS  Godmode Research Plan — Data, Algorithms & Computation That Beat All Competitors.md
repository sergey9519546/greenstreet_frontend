...
All deterministic math runs in a **pure Python module with zero ML, zero approximation, zero prose-based formulas**. Every function has a corresponding pytest golden test pinned to the v11.0 numerical anchors.
