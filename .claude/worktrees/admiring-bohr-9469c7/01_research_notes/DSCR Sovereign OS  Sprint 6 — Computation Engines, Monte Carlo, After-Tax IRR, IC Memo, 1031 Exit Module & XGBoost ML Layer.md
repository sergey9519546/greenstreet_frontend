...
status: drafted
confidence: 3
title: "DSCR Sovereign OS: Sprint 6 — Final Computation Engines"
summary: "**Classification:** SOVEREIGN | **Executed:** June 18, 2026 | **Sprint:** 6 of 6"
entities:
...
tags:
  ...
  - topic/tax
  - type/audit
source: "DSCR Sovereign OS  Sprint 6 — Computation Engines, Monte Carlo, After-Tax IRR, IC Memo, 1031 Exit Module & XGBoost ML Layer.md"
...
def compute_arm_reset_rate(
    ...
    return {
        ...
        'note':                  f'5/6 ARM reset at mo.60: projected {reset_schedule[-1]["capped_rate"]:.2%} vs initial {initial_rate:.2%}. Current flat SOFR curve → ARM resets may actually reduce payments vs. initial fixed rate.'
    }
```
...
| Section 1071 broker exemption | 4 | ✅ Confirmed — lenders only (≥1,000 loans/yr) |
