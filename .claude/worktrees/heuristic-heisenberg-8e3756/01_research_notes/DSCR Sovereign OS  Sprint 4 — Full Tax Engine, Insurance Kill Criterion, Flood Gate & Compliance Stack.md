...
tags:
  ...
  - topic/short-rate
  - topic/tax
source: "DSCR Sovereign OS  Sprint 4 — Full Tax Engine, Insurance Kill Criterion, Flood Gate & Compliance Stack.md"
...
- **Exception:** Old tiered schedule remains in effect for pre-final-rule compliance obligations:[^31]
  ...
  - Tier 3 (≥1,000 originations): collect starting October 1, 2027; report by June 1, 2028
...
| CFPB 1071 broker vs. lender | ✅ CONFIRMED | Broker-only deal desks: EXEMPT; lender-originators: covered if ≥1,000 originations |
