...
status: drafted
confidence: 3
title: Master DSCR Knowledge Document
summary: This document synthesizes information from various provided sources related to Debt Service Coverage Ratio (DSCR) loans, including lender guidelines, technical specifications, strategic blueprints, and research reports. The goal is to provide a comprehensive and reconciled view of DSCR lending, prioritizing the most current and authoritative information, particularly primary lender guidelines and validated technical specifications for 2026.
entities:
  - concept/arm
  - concept/dscr
  - concept/io
...
tags:
  ...
  - topic/tax
  - type/audit
source: Master DSCR Knowledge Document.md
