...
export const POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      { list: [
        ...
        "≤ 75% LTV (25% down) — The sweet spot for Greenstreet's best-priced tier. Most programs publish their headline rate here.",
      ...
      { h: "FICO tiers" },
      { p: "FICO drives both rate and program access. The breakpoints vary by lender, but a representative tiering across Greenstreet's DSCR programs is:" },
      { list: [
        ...
        "660–679 — Minimum FICO for Oak, Willow, and Magnolia; all seven Greenstreet programs are still available at this tier.",
        "640–659 — Oak, Willow, and Magnolia drop out (660 floor). Maple, Birch, Cedar, and Aspen remain, each on its own pricing grid.",
      ]},
  ...
  },
  {
    ...
    body: [
      ...
      { p: "FICO floors vary by program: Maple and Birch go down to 620, Cedar and Aspen require 640, and Oak, Willow, and Magnolia need 660+. If the borrower is at 640–659, Cedar or Aspen may apply. Below 640, only Maple and Birch remain, and pricing tightens fast. Fix options: pay down revolving balances before application (utilization below 30% often moves scores 20–40 points over 30–60 days), dispute legitimate errors, or wait for a seasoning cycle on a derogatory." },
  ...
  },
  {
    ...
    body: [
      ...
      { list: [
        ...
        "The distinction matters because program availability differs: ITIN borrowers access most standard DSCR programs with minor overlays; foreign nationals with no U.S. credit need one of Greenstreet's foreign-national programs — Maple, Aspen, Willow, or Magnolia.",
      ]},
  ...
  },
  {
    ...
    summary: "The '740 FICO, ≤75% LTV' tier is real on Greenstreet's best-priced tier — our lowest rate sheet. Here's exactly what it takes to hit it.",
    body: [
  ...
  // ── NEW: STR/Airbnb qualifying income ────────────────────────────────────────
  {
    ...
    body: [
      ...
      { p: "Greenstreet's 1–4 unit DSCR programs — Maple, Oak, Cedar, Aspen, and Willow — cover STR with 12 months of documented history. InvestGO covers STR properties where 1007 long-term rent is used as the qualifying figure (no history required). The best-priced tier is available on STR if DSCR ≥ 1.20x using documented history at 740+ FICO, ≤75% LTV. STR condotels and short-term rental condos have additional program restrictions — confirm property type eligibility before the appraisal is ordered." },
  ...
  // ── NEW: Document checklist ───────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { list: [
        ...
        "Social Security Number (or ITIN): for credit pull authorization. Foreign nationals with no SSN or ITIN use one of Greenstreet's foreign-national programs (Maple, Aspen, Willow, or Magnolia) — see the Foreign Nationals article.",
