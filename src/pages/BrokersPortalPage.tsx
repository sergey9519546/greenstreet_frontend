    ...
    >
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "40px" }}>
        <AnimatedCard hoverScale={true} style={{ padding: "32px", background: "rgba(0,101,101,0.08)", borderRadius: "14px", border: "1px solid rgba(0,101,101,0.22)" }}>
          ...
          <p style={{ fontSize: "15px", color: "#4a5d5d", lineHeight: 1.6, marginBottom: "20px" }}>
            Per broker. On average. The DSCR solver, program match, and state-rule checks mean you stop second-guessing your quote and move on.
          </p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "40px" }}>
        {[
          ...
          { title: "Program Match Scoring", desc: "Your file scored against each Greenstreet program with the three reasons and two concerns spelled out. No more guessing which program to apply for.", icon: "2" },
      ...
      <AnimatedCard hoverScale={false} style={{ marginBottom: "32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px" }}>
          {[
            ...
            { step: "03", title: "Review program match + state rule", desc: "Best-fit Greenstreet programs with reasoning. State PPP auto-checked with no-PPP premium called out." },
