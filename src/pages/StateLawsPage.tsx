...
const TIER_COLORS: Record<Tier, string> = { 0: dc.emerald, 1: dc.lemon, 2: dc.risk.warning, 3: dc.risk.danger, 4: "#a78bfa", 5: "#9aa3ab" };
          ...
          <div className="dc-split" style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: 36, alignItems: "start" }}>
            ...
            <div ref={mapRef} style={{ position: "relative" }}>
              ...
              {hover && (() => {
                ...
                return (
                  <div style={{ position: "absolute", left: pos.x + 14, top: pos.y + 14, pointerEvents: "none", background: dc.dark, color: dc.cream, borderRadius: 8, padding: "10px 13px", maxWidth: 240, border: "1px solid rgba(238,239,211,0.16)", zIndex: 5 }}>
