...
const TOOLS = [
  ...
  { title: "Lender Match", desc: "Every eligible lender ranked 0-100 with reasons and concerns. Updated monthly.", tag: "free", path: "/lender-intel", view: "lender-intel" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "40px" }}>
        <AnimatedCard hoverScale={true} style={{ padding: "32px", background: "rgba(0,101,101,0.08)", borderRadius: "14px", border: "1px solid rgba(0,101,101,0.22)" }}>
          ...
          <p style={{ fontSize: "15px", color: "#4a5d5d", lineHeight: 1.6, marginBottom: "20px" }}>
            Plug in the numbers. See the Track 1 DSCR, the Track 2 cash flow, the rate headroom, and the lender match. Most investors find the binding constraint in the first <AnimatedNumber value={90} format={(v) => Math.round(v).toString()} /> seconds.
          </p>
