          ...
          <div id="gs-hero-content">
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 16, background: "rgba(238,239,211,0.06)", border: "1px solid rgba(238,239,211,0.12)", borderRadius: dc.r.md, padding: "18px 24px", marginBottom: 24 }}>
              <div>
                ...
                <Mono style={{ fontSize: "clamp(26px,5vw,64px)", fontWeight: 600, letterSpacing: "-0.04em", color: irrColor, lineHeight: 1, display: "block" }}>
                  {irrStr}
                </Mono>
              </div>
            ...
            <div className="dc-results-first" style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <div style={{
                ...
                <div style={{ textAlign: "center", paddingBottom: "clamp(20px,2.4vw,28px)", marginBottom: "clamp(20px,2.4vw,28px)", borderBottom: "1px solid rgba(238,239,211,0.16)" }}>
                  ...
                  <Mono style={{ fontSize: "clamp(32px,8vw,104px)", fontWeight: 600, letterSpacing: "-0.04em", color: irrColor, lineHeight: 1, display: "block" }}>
                    {irrStr}
                  </Mono>
