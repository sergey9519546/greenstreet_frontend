    ...
    >
      ...
      >
        <div style={{ maxWidth: dc.maxW, margin: "0 auto" }}>
          ...
          {/* Seed-data notice — SEED loads by default so first-time visitors don't
              mistake the example rows for a previously saved portfolio. Disappears
              as soon as rows are edited, added, or removed. */}
          {rows === SEED && (
            <div
              style={{
                display: "inline-flex",
