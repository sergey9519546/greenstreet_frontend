...
// LenderProgram is declared in ../types; lenders.ts only re-imports it, so
// importing it from ../lenders does not resolve.
import type { PPPStateLaw, LenderProgram } from '../types';
