...
const ARTICLE_TITLES: Record<string, string> = {
  "greenstreet-go-launch": "Greenstreet announces InvestGO, the unified DSCR loan platform",
  ...
  "obbba-2025-real-estate-tax-changes": "OBBBA 2025: Three tax changes every real estate investor needs to know",
  "mn-hf3437-business-purpose": "MN HF 3437 enacted: DSCR loans now business-purpose in Minnesota",
  "qoz-qrof-permanent-obbba": "QOZ and QROF: what the OBBBA did to Opportunity Zone investing",
  "section-1071-final-rule-dscr": "Section 1071 is live: what DSCR lenders actually need to do",
  "june-2026-rate-sheet": "June 2026 DSCR rate sheet: where the 6.125% specials actually are",
  "fema-rr2-coastal-dscr": "FEMA Risk Rating 2.0: why coastal DSCR deals are failing at the insurance step",
  "why-no-llm-number-path": "Why we put no LLM in the number path — and never will",
  "dscr-str-airbnb-qualifying-income": "Short-term rental (STR/Airbnb) income: how DSCR lenders actually qualify it",
