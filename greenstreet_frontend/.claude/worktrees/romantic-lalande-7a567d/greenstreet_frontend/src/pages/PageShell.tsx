            ...
            <a className="nav-logo-wrap w-inline-block" href="/" onClick={(e) => { e.preventDefault(); onBack(); }}>
              <div className="nav-logo w-embed">
                <span style={{
                  ...
                  wordSpacing: "0.055em"
                }}>Greenstreet<span style={{ fontWeight: 380, fontVariationSettings: '"wght" 380', letterSpacing: "0.006em" }}> Finance</span><span style={{ color: LEMON, fontSize: "1.2em" }}>.</span></span>
              </div>
            </a>
