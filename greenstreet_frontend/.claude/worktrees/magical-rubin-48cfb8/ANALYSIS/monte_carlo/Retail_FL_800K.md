...
| Metric | Value |
|--------|-------|
| Default Probability | 67.6% |
| Expected Loss | 30.42% |
| Loss Given Default | 45% |
| Cash Flow (final) | $-1,465/mo |
| Positive CF | 36% |
| IRR | 5.7% |
...
| Metric | Value |
|--------|-------|
| Final Property Value | $1,400,272 |
| Final Equity | $879,502 |
